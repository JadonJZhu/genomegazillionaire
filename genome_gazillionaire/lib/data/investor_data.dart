...
List<Investor> investorData = [
  Investor(
    ...
    investmentDescription: "Cloudy Balwani is considering a one-time investment of \$1 million into your company for 5% of your total profits going forward. His investment will give your company a large sum of money to reinvest in its processes and increase its rate of profit, but beware, Cloudy is not one to take a bad deal.",
    profitsPercent: 5,
    offeredMoney: 1000000,
    minDiceRoll: 4,
  ),
  Investor(
    ...
    investmentDescription: "Channing Bobson is considering a one-time investment of \$5 million into your company for 10% of your total profits going forward. As an industry veteran, his investment would represent a significant increase in credibility for your company.",
    profitsPercent: 10,
    offeredMoney: 5000000,
    minDiceRoll: 5,
  ),
  Investor(
    ...
    investmentDescription: "Elizabeth House is considering a one-time investment of \$10 million into your company for 15% of your total profits going forward. Getting her investment would mean acquiring a huge sum of money for your company to expand, but beware, she is not one to make a losing investment.",
    profitsPercent: 15,
    offeredMoney: 10000000,
    minDiceRoll: 5,
  ),
  Investor(
    title: "OrbiPharm",
    ...
    avatarFilePath: "../../assets/images/orbipharm.png",
    investmentDescription: "OrbiPharm is considering a one-time investment of \$10 million into your company for 20% of your total profits going forward. Their investment will supply funds to kickstart your company, but beware, you cannot undo this agreement once made. You must lobby OrbiPharm and convince them of your company vision in order to obtain their investment.",
    profitsPercent: 20,
    offeredMoney: 10000000,
    minDiceRoll: 5,
  ),
  Investor(
    ...
    avatarFilePath: "../../assets/images/clyner_parkins.png",
    investmentDescription: "Clyner Parkins is considering a one-time investment of \$20 million into your company for 25% of your total profits going forward. You must prepare a comprehensive presentation of your company mission and methodology in order to bring them over and obtain their investment.",
    profitsPercent: 25,
    offeredMoney: 20000000,
    minDiceRoll: 6,
  ),
  Investor(
    ...
    avatarFilePath: "../../assets/images/crowd_fund.png",
    investmentDescription: "You can launch a crowdfund offering 10% of your company with the goal of raising \$1 million dollars. You must create a compelling crowdfund pitch that will draw in investors from all different walks of life.",
    profitsPercent: 10,
    offeredMoney: 1000000,
    minDiceRoll: 6,
  ),
  Investor(
    title: "GGIH Grant Application",
    description: "An GGIH grant refers to funding provided by the Genome Gazillionaire Institutes of Health (GGIH) to support research and development projects. These grants are typically awarded through competitive application processes and are aimed at advancing scientific knowledge, developing innovative technologies, and addressing healthcare challenges.",
    avatarFilePath: "../../assets/images/ggih.png",
    investmentDescription: "You can apply for an GGIH grant of \$100,000 to support the research and development your company conducts in the process of developing new drugs. Since this is a grant, you will not need to exchange any amount of your profits!",
    profitsPercent: 0,
    offeredMoney: 100000,
    minDiceRoll: 6,
  )
