...
List<Deal> dealData = [
  Deal(
    ...
    negotiationDescription: "You may attempt to negotiate a deal with McKiley & Company in which they will use their market expertise to help your company identify which drugs will become most commercially successful for a flat rate of \$100,000. This will help your company speed up its Gene Selection process and triple its profits.",
    cost: 100000,
    multiplierValue: 100,
    processIndex: 0,
  ...
  Deal(
    ...
    avatarFilePath: "../../assets/images/1.png",
    negotiationDescription: "You may attempt to negotiate a deal with Cooler Fisher Scientific where they will supply a bulk order of their purest DNA Synthesis reagents, specifically DNA polymerases and nucleotides, for the price of \$500,000. These reagents will be used to conduct faster and more precise DNA Synthesis, which will triple the profit of that process.",
    cost: 500000,
    multiplierValue: 50,
    processIndex: 1,
  ...
  Deal(
    ...
    negotiationDescription:
        "You may attempt to negotiate a deal with Vigilant Technologies where they will supply their newest PCR machines that implement a cutting-edge technology to speed up DNA cycling times, which triples the profits of your PCR process. You will attempt to purchase these machines at the discounted rate of \$1,000,000 with the enticement that your company provides feedback on their user experience.",
    cost: 1000000,
    multiplierValue: 30,
    processIndex: 2,
  ...
  Deal(
    ...
    avatarFilePath: "../../assets/images/1.png",
    negotiationDescription:
        "You may attempt to negotiate a deal with Conmega Corporation where they will help you identify which restriction enzymes are best suited to your target gene and subsequently supply those enzymes for a flat rate of \$2,000,000. These specific and accurate restriction enzymes will allow your company to make Recombinant Plasmids with greater efficiency and smaller amounts of waste, thereby increasing the profits of that process by 15 times.",
    cost: 2000000,
    multiplierValue: 15,
    processIndex: 3,
  ...
  Deal(
    ...
    avatarFilePath: "../../assets/images/1.png",
    negotiationDescription:
        "You may attempt to negotiate a deal with Celltreat where they will supply an order of richer, more nutritious bacteria culture mediums for a corporate pricing of \$5,000,000. This improved growing environment increases the chance of successful bacterial transformation (the process in which a bacteria accepts a plasmid) and allows your bacteria to divide at a faster rate, thus increasing the profits of Bacterial Protein Expression by 10 times.",
    cost: 5000000,
    multiplierValue: 10,
    processIndex: 4,
  ...
  Deal(
    ...
    avatarFilePath: "../../assets/images/1.png",
    negotiationDescription:
        "You may attempt to negotiate a deal with Avantore where they will supply an order of protein extractor kits for a corporate pricing of \$10,000,000. These kits will help your scientists speed up the process of Protein Purification, increasing your profits by 10 times.",
    cost: 10000000,
    multiplierValue: 10,
    processIndex: 5,
  ...
  Deal(
    ...
    avatarFilePath: "../../assets/images/1.png",
    negotiationDescription:
        "You may attempt to negotiate a deal with Barnie & Thornberg in which they will assign an additional patent lawyer to your company for \$20,000,000. This patent lawyer will help review and file patent applications for your company’s newest breakthrough, helping your company capitalize on every possible opportunity. This will increase your Patent Filing profits by 8 times.",
    cost: 20000000,
    multiplierValue: 8,
    processIndex: 6,
